...
void output_drill_hole(real drill_x, real drill_y, real depth)
{
    if (SIMPLE_DRILL_CODE) {
        ...
        // TIMO:    I edited this because spot drills during etching, except the first one, showed the full drill depth.
        //          That can't be the purpose of a spot drill! It also ruins my V-engraving bits.
