...
string TOOL_CHANGE_TABLE_FORMAT(int tool_number, real size_inch, real size_mm, real min_drill, real max_drill, int count)
{
  string formatted;
  
  sprintf(formatted, COMMENT_BEGIN + " " + TOOL_CODE + " " + TOOL_INCH_FORMAT + "/" + TOOL_MM_FORMAT + " " + TOOL_INCH_FORMAT + " " + TOOL_INCH_FORMAT + " " + COMMENT_END + EOL,
    tool_number, size_inch, size_mm, min_drill, max_drill);
  return(formatted);
}
